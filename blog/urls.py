...
urlpatterns = [
    ...
    url(r'^activity/(?P<pk>[0-9]+)/$', views.post_activity_detail, name='post_activity_detail'),
    ...
    url(r'^activity/(?P<pk>\d+)/edit/$', views.post_activity_edit, name='post_activity_edit'),
    ...
    url(r'^activity/(?P<pk>[0-9]+)/delete/$', views.post_activity_delete, name='post_activity_delete'),
    ...
    url(r'^activity/explore/tags/(?P<tag>\w+)/$', views.post_activity_list, name='post_activity_search'),
]
